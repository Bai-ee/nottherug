    ...
    >
      ...
      >
        ...
        <div style={{ display: 'flex', gap: 8, justifyContent: 'center' }}>
          <button type="button" className="btn btn-primary booking-forward-btn btn-sm admin-btn-secondary" onClick={onCancel}>Cancel</button>
          <button type="button" className="btn btn-primary booking-forward-btn btn-accent btn-sm" onClick={onConfirm}>Delete</button>
        </div>
      </div>
    </div>
  );
