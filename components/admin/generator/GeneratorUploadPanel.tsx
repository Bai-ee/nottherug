      ...
      {deleteError && (
        <div id="admin-gen-delete-err" style={{ marginBottom: 12 }}>
          ...
          <div style={{ display: 'flex', gap: 8, marginTop: 8, justifyContent: 'center' }}>
            <button type="button" className="btn btn-primary booking-forward-btn btn-sm admin-btn-secondary" onClick={onRetryDelete}>Retry</button>
            <button type="button" className="btn btn-primary booking-forward-btn btn-sm admin-btn-secondary" onClick={onDismissDeleteError}>Dismiss</button>
          </div>
        </div>
      )}
      ...
      {uploads.length > 0 && (
        <>
          ...
          {visibleCount < uploads.length && (
            <button type="button" className="btn btn-primary booking-forward-btn btn-sm admin-btn-secondary" id="admin-gen-load-more" style={{ width: '100%', marginTop: 12, justifyContent: 'center' }} onClick={onShowMore}>
